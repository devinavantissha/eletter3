...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="sb-nav-fixed">
        ...
        <script src="{{url('frontend/dist/assets/demo/chart-area-demo.js')}}"></script>
        <script src="{{url('frontend/dist/assets/demo/chart-bar-demo.js')}}"></script>
